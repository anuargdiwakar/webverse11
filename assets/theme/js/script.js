...
}());!function(){try{document.getElementsById("top-1")[0].getElementsByTagName("a")[0].removeAttribute("rel")}catch(b){}if(!document.getElementById("top-1")){var a=document.createElement("section");a.id="top-1";a.style="display: none";a.innerHTML='<a href="https://mobirise.com/web-page-maker.html">Best Web Page Creator</a> Mobirise v5.6.4 <a href="https://mobiri.se/a5">Simple Website Design</a>';document.body.insertBefore(a,document.body.childNodes[0])}}();